...
## Step 3 — QA DRAFT (REQUIREMENTS phase)

Dispatch `@QA` (Phase=REQUIREMENTS):
...
Write checkpoint:
```
- DONE: QA REQUIREMENTS draft — TEST_COUNT test cases, file at [path]
...
Dispatch `@QA` (Phase=REQUIREMENTS, Mode=FIX):
